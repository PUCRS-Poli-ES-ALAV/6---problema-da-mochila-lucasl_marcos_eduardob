...
3. Resolva o problema da mochila conforme o enuciado em sala de aula. 
   ...
   2. Contabilize o número de iterações;
   3. Implemente e teste sua solução, para o caso exposto em aula e outros de mesmo porte (;-)).
...
6. Resolva o problema da distância de edição conforme o enuciado em sala de aula.
   ...
   i. Ache uma solução que testa todas as combinações possíveis e seleciona a melhor, aplicando divisão-e-conquista ou não;
   ii. Contabilize o número de iterações;
   iii. Implemente e teste sua solução, para (pelos menos) os caso abaixo.
